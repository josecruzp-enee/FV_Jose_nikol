...
# =========================================================
# UTILIDAD LECTURA SEGURA (dict o dataclass)
# =========================================================
...
def p1_tabla_solucion_unica(datos, sizing, energia, financiero, pal, content_w):
    ...
    energia_12m = leer(energia, "energia_12m", [])
...
def build_page_1(resultado, datos, paths, pal, styles, content_w, safe_image):
    ...
    story.append(
        Paragraph("Reporte Ejecutivo — Evaluación Fotovoltaica", styles["Title"])
    )
